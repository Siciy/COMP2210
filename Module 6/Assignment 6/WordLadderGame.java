...
public interface WordLadderGame {
    ...
    //DO NOT ITERATE OVER LEXICON
    //CONSTRUCT THE NEIGHBORS 
    //LINEAR SCAN THE WORD
    //CALL ISWORD N*25 TIMES
    //HOW DO I STORE DATA TO MAKE IT EFFICENT
    /**
    ...
    //LINEAR SCAN THE ADJACENT ELEMENT
    //SN AND SN+1=ISWORD + HAMMING DISTANCE 1
    ...
    */
    ...
    //QUEUE WORD, FIND NEIGHBORS OF WORD, ARRAYDECK IMPLEMENTATION, CHECK BEFORE ENQUEUE, TEST CASES HAT AND BAT
    //EMBED HAVE I ALREADY ENQUEUED
    //DO NOT SEARCH THE QUEUE
    //KEEP A DATA STRUCTURE OF ALREADY CHECKED NEIGHBORS
